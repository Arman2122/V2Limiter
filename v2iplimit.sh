...
download_program() {
    ...
    if [ "$architecture" == "x86_64" ]; then
        url="https://github.com/Arman2122/V2Limiter/releases/download/1.0.6/v2iplimit_amd64_linux.bin"
        filename="v2iplimit_amd64.bin"
    elif [ "$architecture" == "aarch64" ]; then
        url="https://github.com/Arman2122/V2Limiter/releases/download/1.0.6/v2iplimit_arm64_linux.bin"
